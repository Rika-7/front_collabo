        ...
        <ChartCard title="学部別依頼数">
          ...
          <ChartCard title="成果物の種類・件数">
            <LineChart data={fundingTrend}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="amount" name="資金額" stroke="#82ca9d" strokeWidth={2} />
            </LineChart>
          </ChartCard>
          ...
          <ChartCard title="業種別成約率">
            ...
            >
              ...
              <Bar dataKey="failedOrders" name="未成功" stackId="a" fill="#FF8042" />
            </BarChart>
          </ChartCard>
          ...
          <ChartCard title="業種別成約率">
            ...
            >
              ...
              <XAxis dataKey="industry" />
              <YAxis />
              <Tooltip formatter={(value) => [`${Number(value).toLocaleString()}円`, '平均予算']}/>
              <Legend />
          ...
          <ChartCard title="企業の研究分野傾向">
            <RadarChart data={fieldRadar}>
              ...
              <PolarRadiusAxis />
              <Radar name="件数" dataKey="value" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
              <Legend />
            </RadarChart>
          </ChartCard>
          ...
          <ChartCard title="継続案件の推移">
            <LineChart data={continuousLine}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="count" name="継続件数" stroke="#8884d8" strokeWidth={2} />
            </LineChart>
          </ChartCard>
          </div>
        </main>
